...
def parse_args():
    ...
    p.add_argument("--raw-ns", default="/vive_vr/raw", help="namespace the client publishes into")
    p.add_argument("--out-ns", default="/vive_vr", help="namespace the PC side publishes into")
...
async def main(args):
    ...
    async with websockets.connect(url, max_size=None) as ws:
        ...
        for topic, type_ in [
            ...
            (gaze_topic, "vive_vr_ros2/msg/EyeGaze"),
        ]:
