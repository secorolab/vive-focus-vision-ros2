...
"""Drives the raw topics like the headset would and checks what vr_teleop publishes.
...
class Driver(Node):
    def __init__(self):
        ...
        self.pose_pub = self.create_publisher(PoseStamped, "/vr/raw/right/pose", SENSOR)
        self.joy_pub = self.create_publisher(Joy, "/vr/raw/right/joy", SENSOR)
        self.deltas = []
        self.clutch = []
