...
- [OpenArm simulation](openarm_sim.md) — right-arm IK, controller alignment and launch commands
- [Teleoperation](teleop.md) — the clutch, the delta stream, and why it needs no
  calibration
