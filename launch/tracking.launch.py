...
def generate_launch_description():
    default_params = os.path.join(
        get_package_share_directory("vive_vr_ros2"), "config", "vive_vr.yaml"
    )
    ...
    return LaunchDescription(
        ...
        + [
            ...
            Node(
                package="vive_vr_ros2",
                executable="vive_vr_discovery",
                name="vive_vr_discovery",
                output="screen",
                arguments=[
